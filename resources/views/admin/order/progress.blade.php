...
@section('judul', 'Daftar Order dibayar')
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @can('edit-user')
                                <form action="/admin/{{ $o->id }}/confirm" method="post">
                                    @method('patch')
                                    @csrf
                                    <button type="submit" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Confirm">Confirm</button>
                                </form>
                                @endcan
                            </td>
                        </tr>
